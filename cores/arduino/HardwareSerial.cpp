...
void HardwareSerial::setHandler(void *handler) {
    _serial.uart = (UART_TypeDef *) handler;
}
...
UART_TypeDef UART0 = {0, UART0_BASE};
#endif
#if defined(UART1_BASE)
UART_TypeDef UART1 = {1, UART1_BASE};
#endif
#if defined(UART2_BASE)
UART_TypeDef UART2 = {2, UART2_BASE};
#endif
#if defined(UART3_BASE)
UART_TypeDef UART3 = {3, UART3_BASE};
#endif
#if defined(UART4_BASE)
UART_TypeDef UART4 = {4, UART4_BASE};
#endif
#if defined(UART5_BASE)
UART_TypeDef UART5 = {5, UART5_BASE};
#endif
#if defined(UART6_BASE)
UART_TypeDef UART6 = {6, UART6_BASE};
#endif
#if defined(UART7_BASE)
UART_TypeDef UART7 = {7, UART7_BASE};
#endif
